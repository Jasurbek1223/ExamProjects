<template>
  ...
  <div class="hidden md:flex items-center justify-center gap-5">
    <button class="text-sm font-bold text-textPrimary">
    ...
    <button class="flex px-2 gap-3 items-center border p-2 rounded-full border-gray-300 shadow-md hover:shadow-lg">
      <div class="pl-[10px]">
      ...
      <div class="h-[32px] w-[32px] text-logoSecondary">
