<template>
  ...
  <div class="rounded-xl">
    ...
    <div class="flex justify-between mt-2">
      ...
      <!-- About -->
      <div class="basis-2/3">
        <h5 class="font-medium line-clamp-1">{{location.placeName}}</h5>
        <p class="text-textSecondary">Built in {{location.builtIn}}</p>
        <p class="text-textSecondary">{{location.days}}</p>
        <h5>
