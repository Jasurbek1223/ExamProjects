...
public class NotificationSubscriber(
    ...
    [
        EventBusConstants.ProcessNotificationQueueName, EventBusConstants.RenderNotificationQueueName,
...
)
{
        ...
        CancellationToken cancellationToken)
    {
        var eventHandler = () => @event switch
        {
            ProcessNotificationEvent processNotificationEvent => ProcessNotificationAsync(processNotificationEvent,
                cancellationToken),
            RenderNotificationEvent processNotificationEvent => RenderNotificationAsync(processNotificationEvent,
                cancellationToken),
            SendNotificationEvent processNotificationEvent => SendNotificationAsync(processNotificationEvent,
                cancellationToken),
    ...
    private async ValueTask SendNotificationAsync(SendNotificationEvent sendNotificationEvent,
        CancellationToken cancellationToken)
    {
        await using var scope = serviceScopeFactory.CreateAsyncScope();
